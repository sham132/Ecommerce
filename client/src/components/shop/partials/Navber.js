...
import Logo from '../../../components/shop/logo.jpg'
import companyLogo from '../../../components/shop/cart.png';
      ...
      <nav className="fixed top-0 w-full z-20 shadow-lg lg:shadow-none bg-white">
        <div className="m-4 md:mx-12 md:my-6 grid grid-cols-4 lg:grid-cols-3">
          <div className="hidden lg:block col-span-1 flex text-gray-600 mt-1">
            ...
            {/* <span
              className="hover:bg-gray-200 px-4 py-3 rounded-lg font-light tracking-widest hover:text-gray-800 cursor-pointer"
              onClick={(e) => window.open("http://codedevz.com/", "_blank")}
            >
              Company
            </span> */}
            <span
              className="hover:bg-gray-200 px-4 py-3 rounded-lg font-light tracking-widest hover:text-gray-800 cursor-pointer"
              onClick={(e) => history.push("/home/contact-us")}
            >
              About Us
            </span>
          ...
          <div
            ...
            className="hidden lg:block flex items-left col-span-1 text-center text-gray-800 font-bold tracking-widest uppercase text-3xl cursor-pointer"
          >
           <b style={{color:'#7f857e'}}><i  > A  <sub>C</sub> I  <sub>S</sub> tore</i></b> 
          </div>
          <div className="flex items-right col-span-2 lg:col-span-1 flex justify-end">
            ...
            <div
              ...
              className="hover:bg-gray-100 px-2 py-2 rounded-lg relative cursor-pointer"
              title="Shopping Cart"
            >
               <img src={companyLogo} alt="Cart" width={37}/>
