...
const Slider = (props) => {
  ...
  // data.sliderImages.forEach(element => {
  
  //   images.push(element.sliderImages[slide].slideImagee)
  //   console.log(element);
 ...
 // console.log(images)
  ...
  //alert(`/uploads/customize/`+data.sliderImages[slide].slideImagee)

  {
    data.sliderImages.forEach(element => {
      images.push(`${apiURL}/uploads/customize/`+element.slideImage);   
    })
  }
  console.log(images)
  return (
