          ...
          return (
            <Fragment key={index}>
              <div className="relative col-span-1 m-2">
                ...
                {/* <div>{item.pPrice}.00   PKR</div> */}

                    {item.pOffer != 0 ? <div> Price:<b> <del style={{color:'red'}}>  {item.pPrice}</del></b> <br></br> <b>Offer : { ( item.pOffer ) } % </b></div> : <div><b>Offer :  {item.pOffer} % </b>  </div>} 
                 
                    <div>{(   item.pPrice - (item.pOffer) *  item.pPrice * 0.01 )}.00   PKR</div>
