        ...
        <div className="grid grid-cols-2 md:grid-cols-12">
          ...
          <div className="col-span-2 mt-8 md:mt-0 md:col-span-4 md:ml-6 lg:ml-12">
            <div className="flex flex-col leading-8">    
             ...
             Price: {(   sProduct.pPrice - (sProduct.pOffer) *  sProduct.pPrice * 0.01 )}.00   PKR  
          
              <div className="flex justify-between items-center">

                
              {sProduct.pOffer != 0 ? <div> <b> <del style={{color:'red'}}>  {sProduct.pPrice}.00 PKR</del></b>  <b>Offer : { ( sProduct.pOffer ) } % </b></div> : <div><b>Offer :  {sProduct.pOffer} % </b>  </div>} 
                    ...
                    <div
                      onClick={(e) =>
                        addToCart(
                          sProduct._id,
                          quantitiy,
                          sProduct.pPrice,sProduct.pWeight,
                          layoutDispatch,
                          setQuantitiy,
                          setAlertq,
                          fetchData,
